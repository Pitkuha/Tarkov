...
public class FighterInventoryPK implements Serializable {
    ...
    public FighterInventoryPK(long fighter_id, long weapon_id, long ammunition_id, long magazine_id, long medicine_id, long provision_id, long armor_id, long helmet_id) {
